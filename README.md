...
This repository contains the formal development of a higher-order probabilistic separation logic for proving differential privacy of higher-order probabilistic programs.
...
- [Mathcomp-analysis](https://github.com/math-comp/math-comp) 1.4.0
...
```
opam switch create clutch-dp 4.14.1
...
opam update
```
4. Install the right version of the dependencies as specified in the `clutch-dp.opam` file.
```

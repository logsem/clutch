...
Section proofs.
  ...
  Proof with try rel_pures_l ; try rel_pures_r.
    ...
    rel_apply_r refines_couple_tapes => // ; iFrame.
    iIntros (b) "[β α]" => /=...
    rel_flip_r...
    rel_alloc_l x as "x"...
    rel_alloc_r y as "y"...
    rel_alloc_l f as "f".
    rel_alloc_r g as "g".
    set (P2 := ((∃ (bx b:bool), ∃ bs, x ↦ #bx ∗ y ↦ₛ #b ∗ α ↪ (b :: bs) ∗ β ↪ₛ bs ∗ f ↦ #true ∗ g ↦ₛ #true))%I).
    set (P3 := ((∃ b:bool, ∃ bs, ∃ bs', x ↦ #b ∗ y ↦ₛ #b ∗ α ↪ bs ∗ β ↪ₛ bs' ∗ f ↦ #false ∗ g ↦ₛ #false))%I).
    ...
    - iApply refines_arrow_val.
      ...
      + rel_load_r...
        ...
        destruct bs.
        * rel_flip_l. rel_flip_r... rel_store_r.
  ...
  Proof with try rel_pures_l ; try rel_pures_r.
    ...
    rel_alloc_l f as "f".
    rel_alloc_r g as "g".
    set (P2 := ((∃ (bx b:bool), x ↦ #bx ∗ y ↦ₛ #b ∗ β ↪ₛ [] ∗ f ↦ #true ∗ g ↦ₛ #true))%I).
    set (P3 := ((∃ b:bool, x ↦ #b ∗ y ↦ₛ #b ∗ β ↪ₛ [] ∗ f ↦ #false ∗ g ↦ₛ #false))%I).
    iApply (refines_na_alloc (P2 ∨ P3) onceN).

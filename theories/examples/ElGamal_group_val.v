...
Let τ := ((() → τG) * (τG → τG * τG))%ty.

Lemma ctx_pk_ots_rnd_real_real_lbl :
  ∅ ⊨ pk_ots_rnd_real ≤ctx≤ pk_ots_rnd_real_lbl : τ.
Proof.
...
Lemma ctx_pk_ots_rnd_real_lbl_0 :
  ∅ ⊨ pk_ots_rnd_real_lbl ≤ctx≤ pk_ots_rnd_0 : τ.
Proof.
  apply (refines_sound clutchRΣ). intros => /=. erewrite τG_closed.
...
Lemma ctx_pk_ots_rnd_0_1 :
  ∅ ⊨ pk_ots_rnd_0 ≤ctx≤ fill C DH_real_lbl : τ.
Proof.
...
Lemma pk_ots_rnd_real_real_ddh :
  ∅ ⊨ pk_ots_rnd_real ≤ctx≤ fill C DH_real_lbl : τ.
Proof.
...
Lemma ctx_pk_ots_rnd_2_3 :
  ∅ ⊨ fill C DH_rnd_lbl ≤ctx≤ pk_ots_rnd_3 : τ.
Proof.
  apply (refines_sound clutchRΣ). intros.
...
Lemma ctx_pk_ots_rnd_3_4 :
  ∅ ⊨ pk_ots_rnd_3 ≤ctx≤ pk_ots_rnd_4 : τ.
Proof.
  apply (refines_sound clutchRΣ). intros => /=. erewrite τG_closed.
...
Lemma ctx_pk_ots_rnd_4_5 :
  ∅ ⊨ pk_ots_rnd_4 ≤ctx≤ pk_ots_rnd_5 : τ.
Proof.
  apply (refines_sound clutchRΣ). intros => /=. erewrite τG_closed.
...
Lemma ctx_pk_ots_rnd_5_rnd :
  ∅ ⊨ pk_ots_rnd_5 ≤ctx≤ pk_ots_rnd_rnd : τ.
Proof.
  apply (refines_sound clutchRΣ). intros => /=. erewrite τG_closed.
...
Lemma pk_ots_rnd_rnd_ddh_rnd :
  ∅ ⊨ fill C DH_rnd_lbl ≤ctx≤ pk_ots_rnd_rnd : τ.
Proof.
  eapply ctx_refines_transitive.
  - eapply ctx_refines_transitive.
    + eapply ctx_refines_transitive.

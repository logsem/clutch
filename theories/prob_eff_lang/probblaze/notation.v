...
Coercion EffName : string >-> eff_val.
Coercion EffLabel : label >-> eff_val.
Coercion Label : nat >-> label.
...
properly. *)
Notation "# l" := (LitV l%Z%stdpp) (at level 8, format "# l").
...
Notation "'effect' s e" := (Effect s%binder e%E)
  (at level 200, s at level 1, e at level 200,
     format "'effect'  s '//' e") : expr_scope.

(* ************************************************************************* *)
(** Performing effects. *)
Notation "'do:' n e" := (Do n e%E)
  (at level 200, n at level 1, e at level 200,

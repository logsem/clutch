...
From clutch.prob_eff_lang.probblaze.examples.DH_KE Require Import mask sec_channel_def mask_bijection.
...
Section schan_security.
  ...
  Definition R_CHAN : val :=
    λ: "f",
      (F_KE_lazy_alice ||ᵣ F_OAUTH) (CHAN "f").
    ...
    + iDestruct "HRecvBob" as "[-> [-> #HmQ]]"...
      { split.
        + apply not_elem_of_cons; split; last (apply neutral_ectx; repeat constructor).
          intro Heq.
          apply NoDup_ListNoDup in Hnd_r.

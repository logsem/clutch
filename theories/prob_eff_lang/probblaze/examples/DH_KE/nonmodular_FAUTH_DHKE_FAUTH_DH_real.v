...
Section verification.
  ...
  Proof using G.
    ...
    - iApply (rel_load_l_mask [HandleCtx _ _ _ _ _; AppRCtx _; CaseCtx _ _]).
      iFrame. iIntros "!> Hla". rel_pures_l.
      iApply (rel_rand_l _ [HandleCtx _ _ _ _ _; AppRCtx _; AppRCtx _]).
      iAssert (α ↪N (n; [fin_to_nat a]))%I with "[Hα]" as "Hα".
      { iExists [a]. simpl. iFrame. done. }
      iFrame. iIntros "!>Hα _". rel_pures_l.
      iApply (rel_store_l _ _ _ [HandleCtx _ _ _ _ _; AppRCtx _; AppRCtx _] with "Hla").
      iIntros "!> Hla".
      rel_pures_l.
      iApply (rel_exp_l _ [HandleCtx _ _ _ _ _ ; AppRCtx _]).
    ...
    1 : {
      do 2 rel_pures_l; [split; first apply Hk1; set_solver|]. 
      do 2rel_pures_r; [split;[apply Hk2; set_solver|set_solver]|].
      iApply (rel_bind' [_] [_]); [iApply traversable_iThyTraverse|].
      iApply rel_introduction'.
      iExists _, _, [], [], _. do 2 (iSplit; [done|]; iSplit; [iPureIntro; apply _|]).
      ...
      * iApply (rel_load_l_mask [CaseCtx _ _ ]). iFrame "Hl2". iIntros "!> _".
        iApply (rel_load_r_with_mask _ _ _ _ [CaseCtx _ _] with "Hl2s"). iIntros "_".
        iApply rel_na_close. iFrame. iSplitL; [iRight; iFrame "#"| ]. simpl.
        rel_pures_l. rel_pures_r; first set_solver.
        iApply (rel_na_inv _ _ betaN ); [set_solver|].
        iFrame "Hinvb". 
        ...
        --  iApply (rel_load_l_mask [HandleCtx _ _ _ _ _; AppRCtx _; CaseCtx _ _]).
            ...
            iApply (rel_store_l _ _ _ [HandleCtx _ _ _ _ _; AppRCtx _; AppRCtx _] with "Hlb").
            iIntros "!> Hlb".
            rel_pures_l.
            iApply (rel_exp_l _ [HandleCtx _ _ _ _ _ ; AppRCtx _]).
            rel_pures_l; [set_solver|].
        ...
        --  iApply rel_na_close. iFrame. iSplitL; [iRight; iFrame "#"|].
            ...
            rel_pures_l. rel_exp_l. rel_pures_l; first set_solver.
            iApply (rel_load_l with "Hl1"). iIntros "!> _".
            iApply (rel_load_r with "Hl1'"). iIntros "_". rel_pures_l.
            rel_pures_r.
            rel_exp_l. rel_pures_l.
            rewrite -expgM. rewrite -ssrnat.multE.
            rewrite -Nat.mul_comm.
  ...
  (* Proof doesn't compile. Needs to be updated to follow the structure of the previous proof. *)

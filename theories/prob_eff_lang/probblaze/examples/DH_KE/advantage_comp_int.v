...
From clutch.prob_eff_lang.probblaze.examples.DH_KE Require Import new_composition_int xor def_dhke sec_channel_def_int new_composition_defs_int.
...
Section adv_comp.
  ...
  Proof using All.
    ...
    - eapply (advantage_triangle _ _ _ _ _ 0 _); last try lra.
      ...
      by apply new_composition_typing_int.REAL_CHAN_DH_RED_sem_typed.
  Qed.

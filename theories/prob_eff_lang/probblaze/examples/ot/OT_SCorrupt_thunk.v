...
Qed.    
  ...
  Lemma OT_real_DH
    ...
    (* BREL F_CRS (OT_Real_Sender_corrupt f1) 
    ...
    BREL (λ: "f" "effs", F_CRS (λ: "doCRS", OT_Real_Sender_corrupt ("doCRS", "effs") "f")) f1
      ≤ (λ: "f" "effs", (reduction DH_rand) (λ: "doCRS", OT_Real_Sender_corrupt ("doCRS", "effs") "f")) f2
    ...
    iApply (brel_wand with "[Herr Hcrs]"); [iApply (fcrs_dh_ideal with "[$][$]")|].
    iIntros (g1 g2) "!# Hgg /=". 

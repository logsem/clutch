...
From clutch.paris Require Import app_weakestpre lifting primitive_laws derived_laws.
From iris.prelude Require Import options.


#[global] Program Instance paris_wptactics_base `{!parisGS Σ} : GwpTacticsBase Σ unit wp.
Next Obligation. intros. by apply wp_value. Qed.
Next Obligation. intros. by apply wp_fupd. Qed.

#[global] Program Instance paris_wptactics_bind `{!parisGS Σ} : GwpTacticsBind Σ unit wp.
Next Obligation. intros. by apply wp_bind. Qed.

#[global] Program Instance paris_wptactics_pure `{!parisGS Σ} : GwpTacticsPure Σ unit true wp.

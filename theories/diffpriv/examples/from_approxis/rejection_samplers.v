...
Proof.
  ...
  eapply ARcoupl_eq_trans_l ; [done|done| |].
  {
    ...
    eapply (wp_adequacy diffprivΣ _ _ _ σ); [done| done |].
    iIntros (?) "rhs _ _".
  ...
  {
    eapply DPcoupl_to_ARcoupl.
    eapply (wp_adequacy diffprivΣ _ _ σ); [done|done|].
    iIntros (?) "? _ _".
    by iApply (@wp_simpl_sampler_prog_annotated _ _ Hineq). }

  eapply DPcoupl_to_ARcoupl.
  eapply (wp_adequacy diffprivΣ); [done|done|].
  iIntros (?) "? _ _".
...
Proof.
  ...
  eapply DPcoupl_to_ARcoupl.
  apply (wp_adequacy_error_lim diffprivΣ); [done|done|].
  iIntros.

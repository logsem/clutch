(** This file extends the Elton program logic with some derived laws (not
...
From clutch.elton Require Export primitive_laws.
...
Definition array `{!eltonGS Σ} (l : loc) (dq : dfrac) (vs : list val) : iProp Σ :=

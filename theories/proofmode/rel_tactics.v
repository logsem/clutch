...
From self.prob_logrel Require Import model rel_rules derived.
...
Lemma tac_rel_bind_r `{!prelocGS Σ} (t' : expr) K ℶ E e t A :
  t = fill K t' →
...
Lemma tac_rel_pure_l `{!prelocGS Σ} K e1 ℶ ℶ' E e e2 eres ϕ n m t A :
  e = fill K e1 →
  PureExec ϕ n e1 e2 →
  ϕ →
  ((m = n ∧ E = ⊤) ∨ m = 0) →
...
Lemma tac_rel_pure_r `{!prelocGS Σ} K e1 ℶ E (e e2 eres : expr) ϕ n t A :
  e = fill K e1 →
  PureExec ϕ n e1 e2 →
  ϕ →
  nclose specN ⊆ E →
...
Lemma tac_rel_load_l_simp `{!prelocGS Σ} K ℶ1 ℶ2 i1 p (l : loc) q v e t eres A :
  e = fill K (Load (# l)) →
...
Lemma tac_rel_load_r `{!prelocGS Σ} K ℶ1 E i1 p (l : loc) q e t tres A v :
  t = fill K (Load (# l)) →
  nclose specN ⊆ E →
...
(** Store *)
Lemma tac_rel_store_l_simpl `{!prelocGS Σ} K ℶ1 ℶ2 ℶ3 i1 (l : loc) v e' v' e t eres A :
  e = fill K (Store (# l) e') →
  IntoVal e' v' →
  MaybeIntoLaterNEnvs 1 ℶ1 ℶ2 →
...
Lemma tac_rel_store_r `{!prelocGS Σ} K ℶ1 ℶ2 i1 E (l : loc) v e' v' e t eres A :
  e = fill K (Store (# l) e') →
  IntoVal e' v' →
  nclose specN ⊆ E →
...
Lemma tac_rel_alloc_l_simpl `{!prelocGS Σ} K ℶ1 ℶ2 e t e' v' A :
  e = fill K (Alloc e') →
  IntoVal e' v' →
  MaybeIntoLaterNEnvs 1 ℶ1 ℶ2 →
...
Lemma tac_rel_alloc_r `{!prelocGS Σ} K' ℶ E t' v' e t A :
  t = fill K' (Alloc t') →
  IntoVal t' v' →
  nclose specN ⊆ E →
...
Lemma tac_rel_alloctape_l_simpl `{!prelocGS Σ} K ℶ1 ℶ2 e t A :
  e = fill K AllocTape →
  MaybeIntoLaterNEnvs 1 ℶ1 ℶ2 →
...
Lemma tac_rel_alloctape_r `{!prelocGS Σ} K' ℶ E e t A :
  t = fill K' AllocTape →
  nclose specN ⊆ E →

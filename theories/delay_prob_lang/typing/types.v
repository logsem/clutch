...
From clutch.delay_prob_lang Require Import lang notation metatheory.
...
(* With the new changes to delay prob lang, we cant compare prod or sums*)
...
typing for AllocN could work. *)
 ...
 | TLam_typed Γ e τ :
  ...
  | TRand  Γ e : Γ ⊢ₜ e : TNat → Γ ⊢ₜ Rand e: TNat
...
Proof. destruct op; simpl; naive_solver.
Qed.

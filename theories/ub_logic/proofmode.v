...
#[global] Program Instance rel_logic_wptactics_base `{!ub_clutchGS Σ} : GwpTacticsBase Σ unit wp.
Next Obligation. intros. by apply ub_wp_value. Qed.
Next Obligation. intros. by apply ub_wp_fupd. Qed.

#[global] Program Instance rel_logic_wptactics_bind `{!ub_clutchGS Σ} : GwpTacticsBind Σ unit wp.
...
#[global] Program Instance rel_logic_twptactics_base `{!ub_clutchGS Σ} : GwpTacticsBase Σ unit twp.
Next Obligation. intros. by apply ub_twp_value. Qed.
Next Obligation. intros. by apply ub_twp_fupd. Qed.

#[global] Program Instance rel_logic_twptactics_bind `{!ub_clutchGS Σ} : GwpTacticsBind Σ unit twp.

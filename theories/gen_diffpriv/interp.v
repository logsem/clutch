...
From clutch.gen_prob_lang Require Import metatheory lang.
From clutch.prelude Require Import asubst properness.
From clutch.gen_diffpriv Require Import primitive_laws model.
From clutch.gen_prob_lang.typing Require Export types contextual_refinement.
...
Section semtypes.
  ...
  Proof.
    ...
    { intros [Hτ | [[τ' ->] | ->]].
      ...
      - rewrite /lrel_car /=.
        iDestruct 1 as (l1 l2 i1 pv1 -> ->) "Hl".
        iDestruct 1 as (r1 r2 i2 pv2 -> ->) "Hr".
        destruct (decide (l1 = r1)); subst.
        + destruct (decide (l2 = r2)); subst; first by eauto.

...
From clutch.diffpriv_simple_pw_again Require Export weakestpre_simple lifting_simple.
...
Context
 ...
 `{!specG_prob_lang Σ, !diffprivWpGS Σ}.
...
Proof using Hinh.
  intros. erewrite !(wp_lift_pure_det_step e1 e2); eauto. intros.

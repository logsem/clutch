...
From clutch.diffpriv_simple_pw_again Require Export weakestpre_simple ectx_lifting_simple weakestpre_simple_prob_lang_resources.
...
Proof.
  ...
  iApply lifting_simple.wp_pure_step_later; first done.
...
(** This is just a wrapper for tp_rand that works with nats
    TODO: Make into tactic *)
Lemma wp_rand_tape_r N z E e K α Φ n ns (_ : to_val e = None) :
  TCEq N (Z.to_nat z) →

...
From clutch.diffpriv_simple_pw_again Require Export primitive_laws_simple.
...
Definition array `{!diffprivGS Σ} (l : loc) (dq : dfrac) (vs : list val) : iProp Σ :=
...
Proof.
  ...
  - by iApply wp_fupd.
  - by iApply wp_bind.
  - by iApply lifting_simple.wp_pure_step_later.
  - by iApply wp_alloc.
  - by iApply wp_load.
  - by iApply wp_store.
Qed.

...
From clutch.diffpriv_simple_pw Require Import weakestpre_simple_pw lifting_simple_pw primitive_laws_simple_pw derived_laws_simple_pw.
From iris.prelude Require Import options.


#[global] Program Instance diffpriv_wptactics_base `{!diffprivGS Σ} : GwpTacticsBase Σ unit wp.
Next Obligation. intros. by apply wp_value. Qed.
Next Obligation. intros. by apply wp_fupd. Qed.

#[global] Program Instance diffpriv_wptactics_bind `{!diffprivGS Σ} : GwpTacticsBind Σ unit wp.
Next Obligation. intros. by apply wp_bind. Qed.

#[global] Program Instance diffpriv_wptactics_pure `{!diffprivGS Σ} : GwpTacticsPure Σ unit true wp.
Next Obligation. intros. by eapply wp_pure_step_later. Qed.

#[global] Program Instance rel_logic_wptactics_heap `{!diffprivGS Σ} : GwpTacticsHeap Σ unit true wp :=
...
#[global] Program Instance rel_logic_wptactics_tape `{!diffprivGS Σ} : GwpTacticsTapes Σ unit true wp :=

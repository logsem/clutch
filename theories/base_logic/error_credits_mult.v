(** This file implements multiplicative error credits *)
...
(** ** RA for the nonnegative reals with addition as the operation. *)
Section nonnegreal.
  ...
  #[local] Instance nonnegreal_valid_instance : Valid (nonnegreal)  := λ r, True.
  #[local] Instance nonnegreal_validN_instance : ValidN (nonnegreal) := λ _ r, True.

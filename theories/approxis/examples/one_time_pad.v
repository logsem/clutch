...
*)
  ...
  Local Instance SYM_otp_scheme `{approxisRGS Σ} : SYM_init :=
    {|  keygen := otp_keygen
      ; enc_scheme := otp_scheme
      ; rand_cipher := otp_rand_cipher |}.

  Definition sym_scheme_tape : expr :=
    (sym_params, (otp_keygen_tape, (λ: <>, otp_scheme)%V), otp_rand_cipher_tape)%E.
  Definition sym_scheme_delay : expr :=
    (sym_params, (otp_keygen, (λ: <>, otp_scheme_delay)%V), otp_rand_cipher)%E.
  ...
  Section proofs.
    ...
    Proof with (rel_pures_l ; rel_pures_r).
      ...
      rewrite /otp_rand_cipher_tape/otp_keygen_tape...
      rel_alloctape_r β as "Hβ".
      rel_alloctape_r α' as "Hα'"...
      rewrite /CPA...
      rewrite /get_enc_scheme/get_keygen...
      rewrite /otp_scheme_delay...
  ...
  Admitted. *)
    ...
    Proof with (rel_pures_l ; rel_pures_r).
      ...
      rewrite /otp_keygen_tape/otp_rand_cipher_tape...

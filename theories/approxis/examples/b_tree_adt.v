...
From clutch.approxis Require Import b_tree.
  ...
  *)
  ...
  Definition R : lrel Σ :=
    LRel (λ v1 v2, ∃ (p1 p2 : loc),
          ⌜ v1 = #p1 ⌝ ∗ ⌜ v2 = #p2 ⌝ ∗
           na_inv approxisRGS_nais bN (btree_inv p1 p2))%I.
  ...
  Proof.
    ...
    iIntros (p1) "Hp1".
    iMod (na_inv_alloc approxisRGS_nais _ bN (btree_inv p1 p2) with "[Hp1 Hp2]") as "Hinv".
...
Section b_tree_ctx_equiv.
  ...
  Proof.
    ...
    { eapply (@refines_sound approxisRΣ); eauto.

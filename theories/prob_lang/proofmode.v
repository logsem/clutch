...
Lemma tac_wp_pure `{!prelocGS Σ} Δ Δ' s E K e1 e2 φ n Φ :
  PureExec φ n e1 e2 →
  φ →
...
Lemma tac_wp_value_nofupd `{!prelocGS Σ} Δ s E Φ v :
...
Lemma tac_wp_value `{!prelocGS Σ} Δ s E (Φ : val → iPropI Σ) v :
...
Lemma tac_wp_bind `{!prelocGS Σ} K Δ s E Φ e f :

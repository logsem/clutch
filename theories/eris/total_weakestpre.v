...
Definition ub_twp_pre `{!erisWpGS Λ Σ}
...
Local Lemma ub_twp_pre_mono `{!erisWpGS Λ Σ}
...
Local Definition ub_twp_def `{!erisWpGS Λ Σ} : Twp (iProp Σ) (expr Λ) (val Λ) () :=
...
Local Lemma ub_twp_unseal `{!erisWpGS Λ Σ} : twp = (@ub_twp_def Λ Σ _).(twp).
